...
Namespace GanttRestrictions
	...
	Partial Public Class GantTest01DataSet
		...
		Public Overrides Function Clone() As Global.System.Data.DataSet
			Dim cln As GantTest01DataSet = (CType(MyBase.Clone(), GantTest01DataSet))
			cln.InitVars()
		...
		Public Shared Function GetTypedDataSetSchema(ByVal xs As Global.System.Xml.Schema.XmlSchemaSet) As Global.System.Xml.Schema.XmlSchemaComplexType
			Dim ds As New GantTest01DataSet()
		...
		Partial Public Class AppointmentsDataTable
			...
			<Global.System.Diagnostics.DebuggerNonUserCodeAttribute()>
			<Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>
			Public Function AddAppointmentsRow(ByVal Type As Integer, ByVal StartDate As DateTime, ByVal EndDate As DateTime, ByVal AllDay As Boolean, ByVal Subject As String, ByVal Location As String, ByVal Description As String, ByVal Status As Integer, ByVal Label As Integer, ByVal ResourceId As Integer, ByVal ResourceIds As String, ByVal ReminderInfo As String, ByVal RecurrenceInfo As String, ByVal PercentComplete As Integer, ByVal CustomField1 As String) As AppointmentsRow
...
'INSTANT VB NOTE: The variable action was renamed since Visual Basic does not handle local variables named the same as class members well:
			<Global.System.Diagnostics.DebuggerNonUserCodeAttribute()>
			<Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>
			Public Sub New(ByVal row_Renamed As AppointmentsRow, ByVal action_Renamed As Global.System.Data.DataRowAction)
...
'INSTANT VB NOTE: The variable action was renamed since Visual Basic does not handle local variables named the same as class members well:
			<Global.System.Diagnostics.DebuggerNonUserCodeAttribute()>
			<Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>
			Public Sub New(ByVal row_Renamed As ResourcesRow, ByVal action_Renamed As Global.System.Data.DataRowAction)
				Me.eventRow = row_Renamed
				Me.eventAction = action_Renamed
			End Sub
...
'INSTANT VB NOTE: The variable action was renamed since Visual Basic does not handle local variables named the same as class members well:
			<Global.System.Diagnostics.DebuggerNonUserCodeAttribute()>
			<Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>
			Public Sub New(ByVal row_Renamed As TaskDependenciesRow, ByVal action_Renamed As Global.System.Data.DataRowAction)
				Me.eventRow = row_Renamed
				Me.eventAction = action_Renamed
			End Sub
...
SELECT UniqueId, Type, StartDate, EndDate, AllDay, Subject, Location, Description, Status, Label, ResourceId, ResourceIds, ReminderInfo, RecurrenceInfo, PercentComplete, CustomField1 FROM Appointments WHERE (UniqueId = @UniqueId)"
		...
		Private Sub InitConnection()
			...
			Me._connection.ConnectionString = My.Settings.Default.GantTest01ConnectionString
		End Sub
		...
		Public Overridable Function Fill(ByVal dataTable As GantTest01DataSet.AppointmentsDataTable) As Integer
		...
		Public Overridable Function GetData() As GantTest01DataSet.AppointmentsDataTable
			Me.Adapter.SelectCommand = Me.CommandCollection(0)
			Dim dataTable As New GantTest01DataSet.AppointmentsDataTable()
		...
		<Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>
		<Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")>
		Public Overridable Function Update(ByVal dataTable As GantTest01DataSet.AppointmentsDataTable) As Integer
		...
		<Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>
		<Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")>
		Public Overridable Function Update(ByVal dataSet As GantTest01DataSet) As Integer
...
SELECT Id, IdSort, ParentId, Description, Color, Image, CustomField1 FROM Resources WHERE (Id = @Id)"
		...
		<Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")>
		<Global.System.ComponentModel.DataObjectMethodAttribute(Global.System.ComponentModel.DataObjectMethodType.Fill, True)>
		Public Overridable Function Fill(ByVal dataTable As GantTest01DataSet.ResourcesDataTable) As Integer
			Me.Adapter.SelectCommand = Me.CommandCollection(0)
			If (Me.ClearBeforeFill = True) Then
				dataTable.Clear()
			End If
		...
		<Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")>
		<Global.System.ComponentModel.DataObjectMethodAttribute(Global.System.ComponentModel.DataObjectMethodType.Select, True)>
		Public Overridable Function GetData() As GantTest01DataSet.ResourcesDataTable
			Me.Adapter.SelectCommand = Me.CommandCollection(0)
			Dim dataTable As New GantTest01DataSet.ResourcesDataTable()
			Me.Adapter.Fill(dataTable)
			Return dataTable
		End Function
		...
		<Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>
		<Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")>
		Public Overridable Function Update(ByVal dataTable As GantTest01DataSet.ResourcesDataTable) As Integer
			Return Me.Adapter.Update(dataTable)
		End Function
	...
	Partial Public Class TaskDependenciesTableAdapter
		...
		Private Sub InitAdapter()
			...
			Me._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[TaskDependencies] ([ParentId], [DependentId], [Type]) VALUES (" &
				"@ParentId, @DependentId, @Type);" & vbCrLf & "SELECT Id, ParentId, DependentId, Type FROM Ta" &
...
SELECT Id, ParentId, DependentId, Type FROM TaskDependencies WHERE (Id = @Id)"
		...
		<Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")>
		<Global.System.ComponentModel.DataObjectMethodAttribute(Global.System.ComponentModel.DataObjectMethodType.Fill, True)>
		Public Overridable Function Fill(ByVal dataTable As GantTest01DataSet.TaskDependenciesDataTable) As Integer
			Me.Adapter.SelectCommand = Me.CommandCollection(0)
			If (Me.ClearBeforeFill = True) Then
				dataTable.Clear()
			End If
		...
		<Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")>
		<Global.System.ComponentModel.DataObjectMethodAttribute(Global.System.ComponentModel.DataObjectMethodType.Select, True)>
		Public Overridable Function GetData() As GantTest01DataSet.TaskDependenciesDataTable
			Me.Adapter.SelectCommand = Me.CommandCollection(0)
			Dim dataTable As New GantTest01DataSet.TaskDependenciesDataTable()
			Me.Adapter.Fill(dataTable)
			Return dataTable
		End Function
		...
		<Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>
		<Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")>
		Public Overridable Function Update(ByVal dataTable As GantTest01DataSet.TaskDependenciesDataTable) As Integer
			Return Me.Adapter.Update(dataTable)
		End Function
	...
	Partial Public Class TableAdapterManager
		...
		<Global.System.Diagnostics.DebuggerNonUserCodeAttribute()>
		<Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>
		Private Function UpdateUpdatedRows(ByVal dataSet As GantTest01DataSet, ByVal allChangedRows As Global.System.Collections.Generic.List(Of Global.System.Data.DataRow), ByVal allAddedRows As Global.System.Collections.Generic.List(Of Global.System.Data.DataRow)) As Integer
		...
		<Global.System.Diagnostics.DebuggerNonUserCodeAttribute()>
		<Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>
		Private Function UpdateInsertedRows(ByVal dataSet As GantTest01DataSet, ByVal allAddedRows As Global.System.Collections.Generic.List(Of Global.System.Data.DataRow)) As Integer
			Dim result As Integer = 0
			If (Me._appointmentsTableAdapter IsNot Nothing) Then
		...
		<Global.System.Diagnostics.DebuggerNonUserCodeAttribute()>
		<Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>
		Private Function UpdateDeletedRows(ByVal dataSet As GantTest01DataSet, ByVal allChangedRows As Global.System.Collections.Generic.List(Of Global.System.Data.DataRow)) As Integer
			Dim result As Integer = 0
			If (Me._taskDependenciesTableAdapter IsNot Nothing) Then
		...
		<Global.System.Diagnostics.DebuggerNonUserCodeAttribute()>
		<Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>
		Public Overridable Function UpdateAll(ByVal dataSet As GantTest01DataSet) As Integer
